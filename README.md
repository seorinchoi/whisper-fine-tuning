...
* **평가 기준**: 검증 세트(화자 비중복)에서 Character Error Rate(CER) 측정
...
* **긴 발화 처리**: 30초 이상 발화는 chunking 필요.
...
* **베이스 모델**: OpenAI Whisper-small
* **데이터**: AI-Hub *노인 자연 발화* (AI-Hub 사용 조건 준수)

> 본 리포지토리/모델 배포 시 각 소스의 라이선스 고지를 포함하세요.
